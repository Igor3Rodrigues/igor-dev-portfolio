      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 max-w-xl mx-auto">{t('services.subtitle')}</p>
          </div>
        </FadeIn>
              ...
              <FadeIn key={service.id} delay={100 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-70 flex flex-col">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/60 leading-relaxed">{t(service.descKey)}</p>
                  </div>
          ...
          {services.slice(2).map((service, index) => {
            ...
            return (
              <FadeIn key={service.id} delay={300 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full ">
                  <div className="mb-4">
